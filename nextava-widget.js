(function() {
  ...
  // Configuration
  const CONFIG = {
    csvUrl: 'https://docs.google.com/spreadsheets/d/e/2PACX-1vRbXDcgBtSfuZPPnCRPXfgfUp3Mdt9iXQua-FxwoT4OvzQyhxJZrzxHda6OXmi_NBsbJzso-n5ik1C7/pub?output=csv',
  ...
  function render(clinic, cacheTimestamp) {
    ...
    if (showUpdated && cacheTimestamp) {
      html += `
        <div style="margin-top: 16px; padding-top: 12px; border-top: 1px solid #f3f4f6;">
          <p style="margin: 0; font-size: 12px; color: #9ca3af; text-align: center;">Updated ${timeAgo(cacheTimestamp)}</p>
        </div>
      `;
    }
